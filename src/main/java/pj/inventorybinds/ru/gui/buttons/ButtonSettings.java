...
public class ButtonSettings extends TexturedButtonWidget {
    private static final Identifier TEXTURE_MAIN = new Identifier(MOD_ID,"textures/gui/button_settings.png");
    ...
    public ButtonSettings(HandledScreen<?> screen, int buttonIndex, int row, String descript, Item items, PressAction pressAction) {
